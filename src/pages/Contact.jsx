...
const contactOptions = [
  {
    title: 'Submit Data',
    description:
      'Have evidence of government GenAI use that is not yet in our database? Help us expand coverage by submitting structured data.',
    icon: (
      ...
      <div className="bg-primary-50 border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <p className="mt-3 text-gray-600 max-w-2xl">
            G3O is a collaborative effort. Whether you want to submit data, report an error, or
